  ...
  return (
    <div className='flex-1 text-xs sm:text-sm flex flex-col justify-center items-center gap-2 sm:gap-4'>
          ...
          <form>  
                ...
                <input type="password" value={password} onChange={(e) => setPassword(e.target.value)} placeholder='Password' className='outline-none text-slate-900 p-2 w-full max-w-[40ch] duration-300 border-b-2 border-solid border-white focus:border-cyan-300' />
            ...
            <h2 className='duration-300 hover:scale-110 cursor-pointer' onClick={() => setIsSigningIn(!isSigningIn)}>{!isSigningIn ? 'Login' : 'Register'}</h2>
